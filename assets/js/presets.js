...
const SLIDER_DEFS = [
  ...
  { key: "saturation", label: "Saturation", min: -100, max: 100, step: 1, default: 0,
    icon: "droplet" },
  { key: "clarity", label: "Clarté (relief)", min: 0, max: 100, step: 1, default: 0,
    icon: "relief" },
  { key: "chromaSmooth", label: "Lissage des couleurs", min: 0, max: 100, step: 1, default: 0,
    icon: "smooth" },
...
const PRESETS = {
  ...
  landscape: [
    { id: "l1", name: "Sommet clair", settings: { brightness: 9, contrast: 22, saturation: 14, temperature: 2, sharpen: 34, vignette: 12, grain: 4, fade: 0, halation: 0, clarity: 55 } },
    { id: "l2", name: "Ciel d'orage", settings: { brightness: -12, contrast: 42, saturation: -6, temperature: -12, sharpen: 28, vignette: 28, grain: 8, fade: 4, halation: 0, clarity: 60 } },
    { id: "l3", name: "Heure dorée", settings: { brightness: 12, contrast: 16, saturation: 24, temperature: 38, sharpen: 16, vignette: 16, grain: 6, fade: 4, halation: 14, clarity: 40 } },
    { id: "l4", name: "Froid glacier", settings: { brightness: 5, contrast: 24, saturation: -18, temperature: -38, sharpen: 24, vignette: 14, grain: 3, fade: 0, halation: 0, clarity: 50 } },
    { id: "l5", name: "Brume dorée", settings: { brightness: 8, contrast: -6, saturation: 2, temperature: 18, sharpen: 10, vignette: 10, grain: 6, fade: 22, halation: 8, clarity: 20 } },
    { id: "l6", name: "Ambre du Pacifique", settings: { brightness: 8, contrast: 10, saturation: 14, temperature: 30, sharpen: 14, vignette: 12, grain: 6, fade: 10, halation: 16, clarity: 30 } },
  ],
  ...
  argentique: [
    { id: "ar1", name: "Or chaud", settings: { brightness: 5, contrast: 14, saturation: 18, temperature: 32, sharpen: 10, vignette: 14, grain: 25, fade: 16, halation: 12 } },
    { id: "ar2", name: "Portrait pastel", settings: { brightness: 8, contrast: -6, saturation: 8, temperature: 18, sharpen: 4, vignette: 10, grain: 25, fade: 20, halation: 6 } },
    { id: "ar3", name: "Tri-couleur N&B", settings: { brightness: 2, contrast: 32, saturation: -100, temperature: 0, sharpen: 18, vignette: 18, grain: 25, fade: 10, halation: 0 } },
    { id: "ar4", name: "Vision nocturne", settings: { brightness: -6, contrast: 20, saturation: 8, temperature: -14, sharpen: 12, vignette: 26, grain: 25, fade: 8, halation: 26 } },
    { id: "ar5", name: "Diapositive vive", settings: { brightness: 4, contrast: 24, saturation: 28, temperature: 8, sharpen: 16, vignette: 8, grain: 25, fade: 2, halation: 6 } },
    { id: "ar6", name: "Instantané carré", settings: { brightness: 10, contrast: -14, saturation: 4, temperature: 20, sharpen: 0, vignette: 30, grain: 25, fade: 32, halation: 4 } },
    { id: "ar7", name: "Sursaturé rétro", settings: { brightness: 3, contrast: 18, saturation: 34, temperature: -4, sharpen: 8, vignette: 28, grain: 25, fade: 6, halation: 10 } },
    { id: "ar8", name: "Rooftop pastel", settings: { brightness: 7, contrast: -18, saturation: -14, temperature: 22, sharpen: 2, vignette: 6, grain: 25, fade: 34, halation: 12 } },
  ],
};
