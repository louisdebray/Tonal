...
const PRESETS = {
  ...
  argentique: [
    { id: "ar1", name: "Or chaud", settings: { brightness: 5, contrast: 14, saturation: 18, temperature: 32, sharpen: 10, vignette: 14, grain: 34, fade: 16, halation: 12 } },
    { id: "ar2", name: "Portrait pastel", settings: { brightness: 8, contrast: -6, saturation: 8, temperature: 18, sharpen: 4, vignette: 10, grain: 26, fade: 20, halation: 6 } },
    { id: "ar3", name: "Tri-couleur N&B", settings: { brightness: 2, contrast: 32, saturation: -100, temperature: 0, sharpen: 18, vignette: 18, grain: 50, fade: 10, halation: 0 } },
    { id: "ar4", name: "Vision nocturne", settings: { brightness: -6, contrast: 20, saturation: 8, temperature: -14, sharpen: 12, vignette: 26, grain: 48, fade: 8, halation: 26 } },
    { id: "ar5", name: "Diapositive vive", settings: { brightness: 4, contrast: 24, saturation: 28, temperature: 8, sharpen: 16, vignette: 8, grain: 20, fade: 2, halation: 6 } },
    { id: "ar6", name: "Instantané carré", settings: { brightness: 10, contrast: -14, saturation: 4, temperature: 20, sharpen: 0, vignette: 30, grain: 38, fade: 32, halation: 4 } },
    { id: "ar7", name: "Sursaturé rétro", settings: { brightness: 3, contrast: 18, saturation: 34, temperature: -4, sharpen: 8, vignette: 28, grain: 36, fade: 6, halation: 10 } },
    { id: "ar8", name: "Rooftop pastel", settings: { brightness: 7, contrast: -18, saturation: -14, temperature: 22, sharpen: 2, vignette: 6, grain: 32, fade: 34, halation: 12 } },
  ],
};
